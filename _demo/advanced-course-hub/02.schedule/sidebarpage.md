...
:fa-desktop: [plugin:page-inject](/slides/unit-01-1?template=partials/swipedecklinkonly)
:fa-desktop: [plugin:page-inject](/slides/unit-01-2?template=partials/swipedecklinkonly)
:fa-book:[plugin:page-inject](/readings/unit-01?template=partials/embedlycardlinkonly)  
...
:fa-desktop: [plugin:page-inject](/slides/unit-02?template=partials/swipedecklinkonly)
:fa-book: [plugin:page-inject](/readings/unit-02?template=partials/embedlycardlinkonly)  
...
:fa-desktop: [plugin:page-inject](/slides/unit-03?template=partials/swipedecklinkonly)
:fa-book: [plugin:page-inject](/readings/unit-03?template=partials/embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  
...
:fa-desktop: [plugin:page-inject](/slides/unit-04?template=partials/swipedecklinkonly)
:fa-book: [plugin:page-inject](/readings/unit-04?template=partials/embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  

#### [:fa-calendar: Week 5 (Oct 4 - 10)](/home/unit-05)
**How to understand and communicate people's needs and behaviors?**   
:fa-desktop: [plugin:page-inject](/slides/unit-05?template=partials/swipedecklinkonly)
:fa-book: [plugin:page-inject](/readings/unit-05?template=partials/embedlycardlinkonly)  
...
:fa-desktop: [plugin:page-inject](/slides/unit-06?template=partials/swipedecklinkonly)
:fa-book: [plugin:page-inject](/readings/unit-06?template=partials/embedlycardlinkonly)  
...
:fa-book: [plugin:page-inject](/readings/unit-07?template=partials/embedlycardlinkonly)

#### :fa-calendar: Week 8 (Oct 25 - Oct 31)
**How to design products for how people think, learn and feel?**  
:fa-desktop: Interaction Design  
:fa-book: [plugin:page-inject](/readings/unit-08?template=partials/embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  

#### :fa-calendar: Week 9 (Nov 1 - 7)
**How to design for mobile and multi-device usage?**  
:fa-desktop: Mobile and Multi-device Design  
:fa-book: [plugin:page-inject](/readings/unit-09?template=partials/embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  
...
:fa-book: [plugin:page-inject](/readings/unit-10?template=partials/embedlycardlinkonly)   
:fa-users: In-class office hours (tentative)  
